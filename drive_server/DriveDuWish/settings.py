"""
Django settings for DriveDuWish project.
...
SECRET_KEY = 'django-insecure-av%wj4fj-fli7#9mgnpo-932lhp(slobt^p0*b3j$q!ja9g3*)'
...
WSGI_APPLICATION = 'DriveDuWish.wsgi.application'
